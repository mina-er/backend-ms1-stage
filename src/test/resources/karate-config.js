function fn() {
    ...
    config.adminUri = config.rootUrl + 'api/admin/';
        ...
        config.notificationDetailUrl = config.adminUri + 'notificationDetail/';
    config.tacheEntiteExterneUrl = config.adminUri + 'tacheEntiteExterne/';
    config.utilisateurUrl = config.adminUri + 'utilisateur/';
    config.typeIdentiteUrl = config.adminUri + 'typeIdentite/';
    config.typeEntiteExterneUrl = config.adminUri + 'typeEntiteExterne/';
    config.prioriteUrl = config.adminUri + 'priorite/';
    config.dossierClientUrl = config.adminUri + 'dossierClient/';
    config.societeUrl = config.adminUri + 'societe/';
    config.notificationUrl = config.adminUri + 'notification/';
    config.roleAssocieUrl = config.adminUri + 'roleAssocie/';
    config.banqueUrl = config.adminUri + 'banque/';
    config.etatAvancementUrl = config.adminUri + 'etatAvancement/';
    config.entiteExterneUrl = config.adminUri + 'entiteExterne/';
    config.associeUrl = config.adminUri + 'associe/';
    config.tacheDetailUrl = config.adminUri + 'tacheDetail/';
    config.typeSocieteUrl = config.adminUri + 'typeSociete/';
