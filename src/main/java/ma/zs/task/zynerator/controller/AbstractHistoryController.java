package ma.zs.task.zynerator.controller;

import jakarta.servlet.http.HttpServletRequest;
import ma.zs.task.zynerator.audit.AuditBusinessObject;
import ma.zs.task.zynerator.converter.AbstractConverter;
import ma.zs.task.zynerator.criteria.BaseCriteria;
import ma.zs.task.zynerator.dto.BaseDto;
import ma.zs.task.zynerator.dto.FileTempDto;
import ma.zs.task.zynerator.exception.BusinessRuleException;
import ma.zs.task.zynerator.exception.GlobalException;
import ma.zs.task.zynerator.export.ExportModel;
import ma.zs.task.zynerator.service.IService;
import ma.zs.task.zynerator.util.*;
